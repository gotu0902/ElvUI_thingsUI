...
![Version](https://img.shields.io/badge/version-4.1.8-pink)
...
- **Group Icons\Bars** - add auras, movable groups of spells, items and Special Icons\Bars.
...
1. Install with wago app.
2. Install profiles with the wago installer ingame.
3. Run the thingsUI plugin installer.
4. Heal things, or not.

Settings: **/ec** -> **Plugins** -> **thingsUI**

## License

MIT. But if you make it better, I'd like to know nad learn from it.

## Credits

- **human** - the basics
- **Anthropic Claude** - vibe coded the base that got it started, assisting alot atm since my dev bud quit the game, lf help ($$$), PR's welcome.
- **Dan G** - big help and tutoring, optimized and fixed a lot of vibes
- **ElvUI Team** - #1, big w

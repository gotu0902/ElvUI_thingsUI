    ...
    local layoutTab = {
        ...
        args = {
            ...
            inheritWidth = {
                ...
                set = function(_, v) setup.inheritWidth = v; ApplyStack(); TUI:QueueClusterUpdate() end,
            },
            widthOffset = {
                ...
                set = function(_, v) setup.widthOffset = v; ApplyStack(); TUI:QueueClusterUpdate() end,
            },
            minWidth = {
                ...
                set = function(_, v) setup.minWidth = v; ApplyStack(); TUI:QueueClusterUpdate() end,
            },
        },
    }

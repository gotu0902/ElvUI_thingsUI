                ...
                args = {
                    ...
                    posGrp = {
                        ...
                        args = {
                            ...
                            anchorXOffset = { order = 6, type = "range", name = "X Offset", min = -800, max = 800, step = 0.01, bigStep = 1,
                                get = function() return gget("anchorXOffset") or 0 end,
                                set = function(_, v) gset("anchorXOffset", v) end },
                            anchorYOffset = { order = 7, type = "range", name = "Y Offset", min = -800, max = 800, step = 0.01, bigStep = 1,
                ...
                args = {
                    ...
                    nameGroup = {
                        ...
                        args = {
                            ...
                            nameXOffset = { order = 3, type = "range", name = "X Offset", min = -50, max = 50, step = 0.01, bigStep = 1,
                                get = function() return gget("nameXOffset") or 4 end, set = function(_, v) gset("nameXOffset", v) end },
                            nameYOffset = { order = 4, type = "range", name = "Y Offset", min = -20, max = 20, step = 0.01, bigStep = 1,
                    ...
                    durationGroup = {
                        ...
                        args = {
                            ...
                            durationXOffset = { order = 3, type = "range", name = "X Offset", min = -50, max = 50, step = 0.01, bigStep = 1,
                                get = function() return gget("durationXOffset") or -4 end, set = function(_, v) gset("durationXOffset", v) end },
                            durationYOffset = { order = 4, type = "range", name = "Y Offset", min = -20, max = 20, step = 0.01, bigStep = 1,
                    ...
                    stackGroup = {
                        ...
                        args = {
                            ...
                            stackXOffset = { order = 4, type = "range", name = "X Offset", min = -50, max = 50, step = 0.01, bigStep = 1,
                                get = function() return gget("stackXOffset") or 0 end, set = function(_, v) gset("stackXOffset", v) end },
                            stackYOffset = { order = 5, type = "range", name = "Y Offset", min = -20, max = 20, step = 0.01, bigStep = 1,
